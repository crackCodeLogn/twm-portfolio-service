...
public class InstrumentMetaDataServiceImpl implements InstrumentMetaDataService {
  ...
  private static final Map<String, String> OVERRIDE_SECTOR_MAPPING =
      ImmutableMap.<String, String>builder()
          ...
          .put("Utilities", "util-power")
          .put("Consumer Cyclical", "consumer")
          .put("Consumer Defensive", "consumer")
          .put("Industrials", "industrials")
          .put("Basic Materials", "metal") // only found for STLC
